...
public class ClientLegacy {
    ...
    public ClientLegacy(String publicKey, String privateKey) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ClientLegacy mainClient = new ClientLegacy("HQHJVipbsTGtqimNuqCgsFU2hUGHpUhALCs5tXhfPqpx", "YGpqa9F75ZWxvDAh1ZHVKTCWVUZHueYgVVFwA4ZenAq");
